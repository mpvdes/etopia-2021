...
*** Datos urbanos
- https://twitter.com/MarJungle/status/1462556934196842497?t=jpNtHi1UEeNxh01QEFf6uw&s=09
- https://www.laopiniondemurcia.es/comunidad/2021/11/21/juez-imputa-cartagena-parque-balsas-59779804.html
...
- http://nosolousabilidad.com/articulos/taxonomia_visualizacion.htm
- https://benfry.com/
- https://flowingdata.com/2018/11/02/how-to-make-frequency-trails-in-r/
- https://github.com/rougier/scientific-visualization-book
*** OpenRefine
- https://guides.library.unlv.edu/open-refine/
- https://guides.library.illinois.edu/openrefine/
- https://guides.library.illinois.edu/openrefine/
- https://docs.openrefine.org/manual/columnediting
- https://casci.umd.edu/wp-content/uploads/2013/12/OpenRefine-tutorial-v1.5.pdf
- https://kb.refinepro.com/2011/09/countif-in-google-refine-with.html
...
*** Alba G. Corral
- https://janebeta7.dropmark.com/1099900
- https://mappa.js.org/docs/examples-leaflet.html
** Sesión 11. 26/11
*** Servicios curly
**** El tiempo
#+begin_src shell
...
https://developer.mozilla.org.cach3.com/es/docs/Web/HTML/Elemento/iframe
*** Aspecto de la terminal
**** Color theme zenburn
Clonamos este repositorio: https://github.com/sonatard/color-theme-zenburn:
#+begin_src shell
  git clone https://github.com/sonatard/color-theme-zenburn.git
#+end_src
Se puede usar de dos maneras, la primera para probarlo y la segunda para hacerlo persistente.
La primera:
#+begin_src shell
...
** Sesión 12. 27/11
*** Rickrolling
Vamos a echar un ojo a algunas [[https://infotics.es/articulo/herramientas-curiosas-en-la-linea-de-comandos/][herramientas curiosas]].

Abre la terminal y ejecuta:
#+begin_src shell
  curl -s -L http://bit.ly/10hA8iC | bash
#+end_src
Un script disponible en su repositorio de github: https://github.com/keroserene/rickrollrc/blob/master/roll.sh

¡SORPRESA! Acabas de ser rickroleado :-)

[[https://en.wikipedia.org/wiki/Rickrolling][Rickrolling]] es:
#+begin_quote
 is a prank and an Internet meme involving an unexpected appearance of the music video for the 1987 song "Never Gonna Give You Up," performed by the English singer Rick Astley. The meme is a type of bait and switch using a disguised hyperlink that leads to the music video. When victims click on a seemingly unrelated link, the site with the music video loads instead of what was expected, and they have been "Rickrolled". The meme has also extended to using the song's lyrics, or singing it, in unexpected contexts.
https://en.wikipedia.org/wiki/Rickrolling
#+end_quote
La autora de esta broma hecha con =curl= es KeroSerene ([[https://twitter.com/kiserene][twitter]],  [[https://github.com/keroserene][github]] e  y tiene proyectos tan chulos como este https://github.com/keroserene/wikicodex

Otra vía de rickrollear es =curl ascii.live/rick=
*** Aplicaciones modernas para la línea de comandos

Acabas de empezar y ya sientes que necesitas algo más? Igual este artículo te da las claves:
https://infotics.es/articulo/diez-aplicaciones-modernas-para-la-linea-de-comandos/
*** HTML
- Un documento markdown con Lorem Ipsum: https://gist.github.com/DominikAngerer/b4a29b5ec9a69fc09546882586bc2d6b y https://gist.githubusercontent.com/DominikAngerer/b4a29b5ec9a69fc09546882586bc2d6b/raw/aeab6fdd6dbbcb7626e2ef2a8123e677cc19dcc1/lorem-markdown.md

*** nano
Atajos de teclado recomendados (suelen funcionar también en la terminal):
- =C-a=, ir al principio de línea.
- =C-e=, ir al final de línea
- =C-cursor_derecha=, avanza una ~palabra~
- =C-cursor_izqda=, retrocede una ~palabra~
- =M-/=, va a la última línea
- =M-\=, va a la primera línea
*** editores de texto visuales
- https://code.visualstudio.com/
- https://www.barebones.com/products/bbedit/index.html
- https://notepad-plus-plus.org/

*** Proyectos
- Alberto, https://borraja.github.io/etopia-2021/
- Ana, https://anamgil.github.io/etopia-2021/
- Cristina, https://heraldoaragon.github.io/mi_repositorio/
- Fran, https://frandolz.github.io/Curso-Etopia-2021/
- José, https://borraja.github.io/etopia-2021/
- MPMAPI, https://mpmapi.github.io/etopia-visualizacion-datos/
- Noemí, https://noemico.github.io/curso-etopia/
- zzmhs4, https://zzmhs4.github.io/etopia_2021/
- Nacho, https://ngimenez82.github.io/CursoEtopia/
- Sonia, https://sonysluna.github.io/comunica-2021/
- 

*** git
Hay alternativas, opciones o complementos para trabajar de otras formas con repositorios git:
- Github CLI, https://cli.github.com/ es la terminal de git de Github. Tiene comandos que solo funcionan para Github.
- Git bash, https://git-scm.com/download/win
- https://github.com/jiarcos/git-para-dummies
- Cambiar el editor por defecto: =git config --global core.editor "nano"=

*** Terminal en W$
Recordemos opciones para tener una terminal Unix en Windows:
- Cygwin, la que hemos empezado a usar.
- WSL, Windows Serving Linux, una virtualización de una terminal de una máquina GNU/Linux en Windows.
- MSYS2, https://www.msys2.org/. Utiliza una versión del gestor de paquetes [[https://archlinux.org/packages/][pacman]] de [[https://archlinux.org/][Archlinux]] por lo que está más actualizada que Cygwin.
- Mintty, https://mintty.github.io/, la que utizan Cygwin y MSYS2.

*** Msys2
Sincronizar la lista de paquetes:

#+begin_src shell
  pacman -Syu
#+end_src
Instalar GCC para empezar a compilar:
#+begin_src shell
  pacman -S --needed base-devel mingw-w64-x86_64-toolchain
#+end_src

*** Trabajos
- https://github.com/ngimenez82/CursoEtopia
- https://ngimenez82.github.io/CursoEtopia/
- https://github.com/AnaMGil/etopia-2021
- https://github.com/noemico/curso-etopia
- https://github.com/Borraja/etopia-2021
- https://github.com/AlbertoGamez/Etopia-2021
- https://github.com/mpmapi/etopia-visualizacion-datos
- https://github.com/SonySLuna/comunica-2021
- https://github.com/zzmhs4/etopia_2021
* Ejemplos
...
- Dollars for Docs, https://projects.propublica.org/docdollars/, http://dansnguyen.github.io/posts/dollars-for-docs/, https://www.propublica.org/nerds/using-google-refine-for-data-cleaning, https://projects.propublica.org/docdollars/doctors/pid/31019
